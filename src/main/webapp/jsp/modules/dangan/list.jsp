                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">档案信息列表</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(danganTypesCell);
                ...
                //详情信息
            var danganContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.danganContent && item.danganContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.danganContent.indexOf('<img');
                var endIndex = item.danganContent.indexOf('>');
                    danganContentCell.innerHTML = item.danganContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.danganContent != null && item.danganContent != "" && item.danganContent.length >= 11) {
                        danganContentCell.innerHTML = item.danganContent.substring(0, 10) + "...";
                } else {
                        danganContentCell.innerHTML = item.danganContent;
                }
            }
            row.appendChild(danganContentCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("dangan/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("adddangan", "adddangan");
            window.location.href = "add-or-update.jsp"
        }
