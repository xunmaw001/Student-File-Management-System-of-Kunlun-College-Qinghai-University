...
<!--/Pre Loader -->
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //出生日期
            var chushengTimeCell = document.createElement('td');
            chushengTimeCell.innerHTML = item.chushengTime;
            row.appendChild(chushengTimeCell);


            //入校日期
            var ruxiaoTimeCell = document.createElement('td');
            ruxiaoTimeCell.innerHTML = item.ruxiaoTime;
            row.appendChild(ruxiaoTimeCell);


            //民族
            var yonghuMinzhuCell = document.createElement('td');
            yonghuMinzhuCell.innerHTML = item.yonghuMinzhu;
            row.appendChild(yonghuMinzhuCell);


            //籍贯
            var yonghuJiguanCell = document.createElement('td');
            yonghuJiguanCell.innerHTML = item.yonghuJiguan;
            row.appendChild(yonghuJiguanCell);


            //所在院系
            var yonghuYuanxiCell = document.createElement('td');
            yonghuYuanxiCell.innerHTML = item.yonghuYuanxi;
            row.appendChild(yonghuYuanxiCell);


            //职务
            var yonghuZhiwuCell = document.createElement('td');
            yonghuZhiwuCell.innerHTML = item.yonghuZhiwu;
            row.appendChild(yonghuZhiwuCell);
