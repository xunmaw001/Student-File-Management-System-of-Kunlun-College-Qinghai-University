                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>出生日期</label>
                                        <input id="chushengTime-input" name="chushengTime" type="text" class="form-control layui-input">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>入校日期</label>
                                        <input id="ruxiaoTime-input" name="ruxiaoTime" type="text" class="form-control layui-input">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>民族</label>
...
<script>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                chushengTime: "required",
                ruxiaoTime: "required",
                yonghuMinzhu: "required",
                yonghuJiguan: "required",
                yonghuYuanxi: "required",
                yonghuZhiwu: "required",
            ...
            messages: {
                ...
                yonghuPhone: "手机号不能为空",
                chushengTime: "出生日期不能为空",
                ruxiaoTime: "入校日期不能为空",
                yonghuMinzhu: "民族不能为空",
                yonghuJiguan: "籍贯不能为空",
                yonghuYuanxi: "所在院系不能为空",
                yonghuZhiwu: "职务不能为空",
                yonghuEmail: "邮箱不能为空",
                yonghuPhoto: "照片不能为空",
            }
    ...
    function dateTimePick() {
            laydate.render({
                elem: '#chushengTime-input'
                ,type: 'date'
            });
            laydate.render({
                elem: '#ruxiaoTime-input'
                ,type: 'datetime'
            });
    }
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#chushengTime-input").val(ruleForm.chushengTime);
        $("#ruxiaoTime-input").val(ruleForm.ruxiaoTime);
