                        ...
                        <form id="register">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                   ...
                                   <div class="form-group col-md-12">
                                       <label>出生日期</label>
                                       <input id="chushengTime-input" name="chushengTime" size="20"  type="month" class="form-control">
                                   </div>
                                   <div class="form-group col-md-12">
                                       <label>入校日期</label>
                                       <input id="ruxiaoTime-input" name="ruxiaoTime" size="20"  type="month" class="form-control">
                                   </div>
                                <div class="form-group col-md-12">
                                    <label>民族</label>
