...
public class JiaoyujingliView extends JiaoyujingliEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		/**
		* 职务的值
		*/
		private String jiaoyujingliValue;
	...
	public JiaoyujingliView() {

	}

	public JiaoyujingliView(JiaoyujingliEntity jiaoyujingliEntity) {
		try {
			BeanUtils.copyProperties(this, jiaoyujingliEntity);
			...
			* 获取： 职务的值
			*/
			public String getJiaoyujingliValue() {
				return jiaoyujingliValue;
			}
			/**
			* 设置： 职务的值
			*/
			public void setJiaoyujingliValue(String jiaoyujingliValue) {
				this.jiaoyujingliValue = jiaoyujingliValue;
			}
